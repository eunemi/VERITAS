...
export default function Header() {
  return (
    <header className="w-full flex flex-col items-center px-margin-mobile md:px-margin-desktop py-stack-md max-w-[1440px] mx-auto border-b border-primary/20 sticky top-0 bg-transparent z-40">
